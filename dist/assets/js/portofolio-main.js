...
var main = (function($) { var _ = {
	...
	settings: {
		...
		// Slide duration (must match "duration.slide" in portofolio-_vars.scss).
			slideDuration: 500,

		// Layout duration (must match "duration.layout" in portofolio-_vars.scss).
			layoutDuration: 750,

		// Thumbnails per "row" (must match "misc.thumbnails-per-row" in portofolio-_vars.scss).
			thumbnailsPerRow: 2,

		// Side of main wrapper (must match "misc.main-side" in portofolio-_vars.scss).
			mainSide: 'right'
